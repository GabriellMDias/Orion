...
| [3](#phase-3) | Reference feature and immediate decisions | in progress | 1-2; discovery may begin earlier | [Approval Request](domains/approval-request.md) and its identity/authorization model are specified; [H-04](human-actions.md#h-04), [H-05](human-actions.md#h-05), and P3.1-P3.3 are complete. P3.4-P3.6 remain pending. |
