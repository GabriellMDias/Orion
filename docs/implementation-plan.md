...
| P8.6 | Verify generators/builds from clean canonical inputs; document safe application rollback versus database forward recovery. | in progress | [Evolution workflow](database/release-evolution.md#validate-schema-changes) distinguishes application rollback from forward database correction; clean-input reproduction pending. |
